...
model_data %>% write_csv("../data/recovr-eval-2024-09-11.csv")
```
...
toronbike_tfilter_km <- calc_total_km(bike_tfilter %>% filter(city == "toronto"))
...
digraph {
	...
	toronbike_tfilter[label="Installs or Upgrades\nwith @@17s Only\n(n=@@5, @@15 km)", pos="3,-1.5!"]
	toronbike_merge[label="Spatially Merged Bikeways\nby Status, Type, and @@17\n(n=@@6, @@16 km)", pos="6,-1.5!"]
	...
	toronbike_raw -> toronbike_verify -> toronbike_itypes -> toronbike_p2011 -> toronbike_tfilter -> toronbike_merge
...
[5]: bike_tfilter %>% filter(city == "toronto") %>% nrow
...
[15]: toronbike_tfilter_km
[16]: toronbike_merge_km
[17]: tunit %>% str_to_title
