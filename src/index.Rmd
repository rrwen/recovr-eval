...
model_data %>% write_csv("../data/recovr-eval-data-2024-08-12.csv")
```
...
# Calculate vars
toronbike_raw_km <- calc_total_km(toronbike_raw)
toronbike_verify_km <- calc_total_km(bike_verify %>% filter(city == "toronto"))
toronbike_itypes_km <- calc_total_km(bike_itypes %>% filter(city == "toronto"))
toronbike_p2011_km <- calc_total_km(bike_p2011 %>% filter(city == "toronto"))
toronbike_sem_km <- calc_total_km(bike_sem %>% filter(city == "toronto"))
toronbike_merge_km <- calc_total_km(bike_merge %>% filter(city == "toronto"))
...
[5]: bike_sem %>% filter(city == "toronto") %>% nrow
...
[11]: toronbike_raw_km
[12]: toronbike_verify_km
[13]: toronbike_itypes_km
[14]: toronbike_p2011_km
[15]: toronbike_sem_km
[16]: toronbike_merge_km
...
fig_flowchart %>%
    ...
    charToRaw %>%
    rsvg_png(
    	"../figures/fig-methods-toronto.png",
    	width = 1920
    )
