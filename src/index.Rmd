...
cat(glue(
	...
	"\n\nNew Columns (", bike_merge %>% ncol - bike_tunits %>% ncol, ")\n",
	paste0(
		"\n* ",
		colnames(bike_merge) %>%
			.[!. %in% colnames(bike_tunits)],
		collapse = ""
	)
))
...
digraph {
	...
	toronbike_tunits[label="Installs or Upgrades\nwith Semesters Only\n(n=@@5)", pos="3,-1.5!"]
	...
	toronbike_raw -> toronbike_verify -> toronbike_itypes -> toronbike_p2011 -> toronbike_tunits -> toronbike_merge
...
[5]: bike_tunits %>% filter(city == "toronto" & (!is.na(`_install_time_semester`) | !is.na(`_upgrade1_time_semester`) | !is.na(`_upgrade2_time_semester`))) %>% nrow
