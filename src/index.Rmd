...
get_cohort_change <- function (
	...
	if (time_value %in% change_tid) { # time value is same as improve time
		out <- time_value
	} else if (any(change_tid < time_value)) { # time value lt improve value then use latest
...
model_data <- bike_ksi %>%
	mutate( # Add whether segments were improved or not
		verify_improve1 = if_else("TRUE" %in% `_improve1`, T, F),
		...
		verify_improve2 = if_else("TRUE" %in% `_improve1`, T, F),
		...
		verify_improve = if_else("TRUE" %in% `_improve`, T, F)
	) %>%
	select(
		...
		bike_upgrade1_time_orig = .data[[glue("_upgrade2_time_{tunit}_group")]],
	...
	rowwise %>%
	mutate( # assign cohort based on improve
		cohort_install = get_cohort_change(bike_install_time_orig, bike_install_type, time),
		cohort_install_pl = get_cohort_change(bike_install_time_orig, bike_install_type, time, c("PL", "BUF")),
		cohort_install_ct = get_cohort_change(bike_install_time_orig, bike_install_type, time, "PBL"),
		cohort_upgrade1 = get_cohort_change(bike_upgrade1_time_orig, bike_upgrade1_type, time),
		cohort_upgrade1_pl = get_cohort_change(bike_upgrade1_time_orig, bike_upgrade1_type, time, c("PL", "BUF")),
		cohort_upgrade1_ct = get_cohort_change(bike_upgrade1_time_orig, bike_upgrade1_type, time, "PBL"),
		cohort_upgrade2 = get_cohort_change(bike_upgrade2_time_orig, bike_upgrade2_type, time),
		cohort_upgrade2_pl = get_cohort_change(bike_upgrade2_time_orig, bike_upgrade2_type, time, c("PL", "BUF")),
		cohort_upgrade2_ct = get_cohort_change(bike_upgrade2_time_orig, bike_upgrade2_type, time, "PBL"),
		cohort_improve1 = get_cohort_change(bike_improve1_time_orig, bike_improve1_type, time),
		cohort_improve1_pl = get_cohort_change(bike_improve1_time_orig, bike_improve1_type, time, c("PL", "BUF")),
		cohort_improve1_ct = get_cohort_change(bike_improve1_time_orig, bike_improve1_type, time, "PBL"),
		cohort_improve2 = get_cohort_change(bike_improve2_time_orig, bike_improve1_type, time),
		cohort_improve2_pl = get_cohort_change(bike_improve2_time_orig, bike_improve2_type, time, c("PL", "BUF")),
		cohort_improve2_ct = get_cohort_change(bike_improve2_time_orig, bike_improve2_type, time, "PBL")
	) %>%
