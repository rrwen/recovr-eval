...
`r ddesc %>% filter(file == "vancouver-bikeways-2024-12-16.geojson") %>% pull(description)`

* **Download Link**: `r ddesc %>% filter(file == "vancouver-bikeways-2024-12-16.geojson") %>% pull(url)`
* **Download Date**: `r format(ddesc %>% filter(file == "vancouver-bikeways-2024-12-16.geojson") %>% pull(download_date), '%B %d, %Y')`
* **Data Updated**: `r format(ddesc %>% filter(file == "vancouver-bikeways-2024-12-16.geojson") %>% pull(update_date), '%B %d, %Y')`
* **Notes**: `r ddesc %>% filter(file == "vancouver-bikeways-2024-12-16.geojson") %>% pull(notes)`

```{r}

# Read data
vancbike_raw <- read_sf("../data/vancouver-bikeways-2024-12-16.geojson")

# Get download date
vancbike_dldate <- ddesc %>% filter(
	file == "vancouver-bikeways-2024-12-16.geojson"
) %>% pull(download_date)
```
...
```{r, cols.print = 3}
vancbike_ddict <- read_csv("../data/vancouver-bikeways-2024-12-16-datadict.csv")
vancbike_ddict
```
...
- [vancouver-bikeways-2024-12-16.geojson](https://github.com/rrwen/recovr-eval/blob/main/data/vancouver-bikeways-2024-12-16.geojson)
- [vancouver-bikeways-2024-12-16-datadict.csv](https://github.com/rrwen/recovr-eval/blob/main/data/vancouver-bikeways-2024-12-16-datadict.csv)

## Calgary Bikeways {.tabset}

`r ddesc %>% filter(file == "calgary-bikeways-2024-12-16.geojson") %>% pull(description)`

* **Download Link**: `r ddesc %>% filter(file == "calgary-bikeways-2024-12-16.geojson") %>% pull(url)`
* **Download Date**: `r format(ddesc %>% filter(file == "calgary-bikeways-2024-12-16.geojson") %>% pull(download_date), '%B %d, %Y')`
* **Data Updated**: `r format(ddesc %>% filter(file == "calgary-bikeways-2024-12-16.geojson") %>% pull(update_date), '%B %d, %Y')`
* **Notes**: `r ddesc %>% filter(file == "calgary-bikeways-2024-12-16.geojson") %>% pull(notes)`

```{r}

# Read data
calgbike_raw <- read_sf("../data/calgary-bikeways-2024-12-16.geojson")

# Get download date
calgbike_dldate <- ddesc %>% filter(
	file == "calgary-bikeways-2024-12-16.geojson"
) %>% pull(download_date)
```
...
```{r, cols.print = 3}
calgbike_ddict <- read_csv("../data/calgary-bikeways-2024-12-16-datadict.csv")
calgbike_ddict
```
...
- [calgary-bikeways-2024-12-16.geojson](https://github.com/rrwen/recovr-eval/blob/main/data/calgary-bikeways-2024-12-16.geojson)
- [calgary-bikeways-2024-12-16-datadict.csv](https://github.com/rrwen/recovr-eval/blob/main/data/calgary-bikeways-2024-12-16-datadict.csv)

## Toronto Bikeways {.tabset}

`r ddesc %>% filter(file == "toronto-bikeways-2024-12-16.geojson") %>% pull(description)`

* **Download Link**: `r ddesc %>% filter(file == "toronto-bikeways-2024-12-16.geojson") %>% pull(url)`
* **Download Date**: `r format(ddesc %>% filter(file == "toronto-bikeways-2024-12-16.geojson") %>% pull(download_date), '%B %d, %Y')`
* **Data Updated**: `r format(ddesc %>% filter(file == "toronto-bikeways-2024-12-16.geojson") %>% pull(update_date), '%B %d, %Y')`
* **Notes**: `r ddesc %>% filter(file == "toronto-bikeways-2024-12-16.geojson") %>% pull(notes)`

```{r}

# Read data
toronbike_raw <- read_sf("../data/toronto-bikeways-2024-12-16.geojson")

# Get download date
toronbike_dldate <- ddesc %>% filter(
	file == "toronto-bikeways-2024-12-16.geojson"
) %>% pull(download_date)
...
```{r, cols.print = 3}
toronbike_ddict <- read_csv("../data/toronto-bikeways-2024-12-16-datadict.csv")
toronbike_ddict
```
...
- [toronto-bikeways-2024-12-16.geojson](https://github.com/rrwen/recovr-eval/blob/main/data/toronto-bikeways-2024-12-16.geojson)
- [toronto-bikeways-2024-12-16-datadict.csv](https://github.com/rrwen/recovr-eval/blob/main/data/toronto-bikeways-2024-12-16-datadict.csv)
...
tm_shape(bike_adj %>% select(-ends_with("comment"))) +
	...
	tm_shape(bike_adj %>% suppressWarnings(st_cast("POINT"))) +
...
bike_sjoin <- bike_adj %>%
	...
	filter( # ensure ksis join to bikeway by city
		city == ksi_city
	) %>%
...
bike_ksi_agg %>%
	select(-dist_min, -dist_max) %>%
	write_csv("../data/recovr-eval-dist-2024-12-10.csv")
...
model_data %>% write_csv("../data/recovr-eval-2024-12-10.csv", na = "")
```
...
model_data_check
model_data_check %>% write_csv("../data/recovr-eval-check-2024-12-10.csv", na = "")
