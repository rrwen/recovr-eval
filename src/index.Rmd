...
stjid_counts <- list()
for (tunit in c("month", "quarter", "third", "half", "semester", "year")) {
	...
	stjid_file <- glue("../data/cache/stjid-{tunit}-{stjid_date}.csv")
